...
//        String pattern = "plan:*"; // You can set a specific pattern to filter the keys, e.g., "plan:*" to get all plan keys.
//        List<String> allKeys = new ArrayList<>();
//        String cursor = ScanParams.SCAN_POINTER_START;
//        ScanParams params = new ScanParams().match(pattern).count(100); // Adjust the count as per your needs.
//
//        do {
