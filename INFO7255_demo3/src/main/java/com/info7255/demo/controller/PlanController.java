...
public class PlanController {
    ...
    public PlanController(PlanService planService, ETagService eTagService, JwtUtil jwtUtil,RabbitTemplate template) {
    ...
    public ResponseEntity<?> deletePlan(@PathVariable String objectId,
     ...
     // Send message to queue for deleting indices
        ...
        return new ResponseEntity<>("{\"message\": \"Plan deleted successfully\"}", new HttpHeaders(),
                HttpStatus.OK);
    }
...
//        List<String> keys = planService.getAllKeys();
